...
`devcontainer-setup`) encode my conventions for the languages and tooling I use
across projects, and ship thin scaffold templates (structural only - no pinned
versions).
